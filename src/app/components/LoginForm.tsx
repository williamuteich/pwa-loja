            ...
            <div className="w-full max-w-sm">
                <div className="bg-white border-2 border-slate-200 rounded-xl p-8 shadow-xl flex flex-col items-center text-center">
                    ...
                    <div className="space-y-1 mb-8">
                        ...
                        <p className="text-slate-400 text-[10px] font-bold uppercase tracking-widest">Painel de Gestão de Produtos</p>
                    </div>
                ...
                <div className="mt-8 flex flex-col items-center gap-2">
                    <span className="text-[9px] font-black uppercase tracking-[0.4em] text-slate-400">TW Serviços Digitais</span>
                </div>
            </div>
        </div>
    );
