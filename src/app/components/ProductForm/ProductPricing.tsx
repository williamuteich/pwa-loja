            ...
            <div className="p-5 space-y-5">
                ...
                <div className="flex items-center justify-between p-4 bg-slate-900 rounded-2xl">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xs font-bold text-slate-300">Margem estimada</span>
                    </div>
                    <span className="text-base font-black text-emerald-400">27.5%</span>
                </div>
            </div>
        </div>
    );
